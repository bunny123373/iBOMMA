          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li><a href="/movies" className="hover:text-white transition-colors">All Movies</a></li>
                <li><a href="/movies?language=Telugu" className="hover:text-white transition-colors">Telugu</a></li>
                <li><a href="/movies?language=Tamil" className="hover:text-white transition-colors">Tamil</a></li>
                <li><a href="/movies?language=Hindi" className="hover:text-white transition-colors">Hindi</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-all">
